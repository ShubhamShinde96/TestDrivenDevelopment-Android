...
class CarFeature {
    ...
    fun carIsTurningOnItsEngineAndIncreasesTheTemperature() = runTest {
        ...
        coroutinesTestRule.advanceTimeBy(6001) // added this because we have added delay in turnOn() of Engine and
        // due to which this test is failing here, as here we're checking the engine.temperature and the engine is increasing
        // the temperature after 6 second delay.
        // you can check by changing the advanceTimeBy value to 5999, the test will fail.
